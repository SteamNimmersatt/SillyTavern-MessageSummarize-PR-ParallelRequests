...
- The `Parallel summaries` setting controls how many messages will be summarized in parallel. Don't set this too high so you won't hit any API request limits.
